...
def SetAssistantStatus(Status):
    with open(rf'{TempDirPath}/Stauts.data',"w",encoding='utf-8') as f:
        f.write(Status)

def QueryModifier(Query):
    new_query = Query.lower().strip()
    query_words = new_query.split()
    question_words = ["how","what","who","what","why","which","whose","whom","can you","what's","what's","where's","how's","can you"]
